...
public class MainDriverCalling {
    ...
    public IOSDriver<MobileElement> driverOne;
    ...
    public IOSDriver<MobileElement> deviceDriverOne() {
        ...
        try {
            logg.info("DriverTwo now try to opened on Device 1");
            System.out.println("http://" + objConfig.getLocalHostUrl() + ":" + rand1 + "/wd/hub");
            driverOne = new IOSDriver<>(new URL("http://" + objConfig.getLocalHostUrl() + ":" + rand1 + "/wd/hub"), caps);
            ...
            logg.info("DriverTwo Opened Successfully on Device 1");
    ...
    public AndroidDriver deviceDriverTwo() {
        ...
        try {
            logg.info("DriverOne now try to opening on Device 2");
